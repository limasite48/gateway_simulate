...
def decode_uplink_payload(type_code: int, payload: bytes):
    ...
    try:
        if type_code == TYPE_CODES["dht22"]:
            ...
            return {
                "status": "ĐÓNG" if percentage_cover > 80 else ("MỞ" if percentage_cover < 20 else "LỬNG"),
